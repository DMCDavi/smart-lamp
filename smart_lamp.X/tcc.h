/* Código de Controle de Luminosidade via Wi-Fi e Web Page by Adriane Rodange Marteletto */
//Inclusão das bibliotecas necessárias.
//Definição das configurações padrões do PIC18F4550 para frequência de oscilação em 20Mhz
#include <xc.h>
#include <stdio.h>
...
void inicioUSART()
{
 ...
 OpenUSART( USART_TX_INT_OFF & USART_RX_INT_ON & USART_ASYNCH_MODE & USART_EIGHT_BIT & USART_CONT_RX & USART_BRGH_HIGH,10 ); //definição do bauld rate como high (/16) 10 é o spbrg para baud rate de 115200 em 20MHz
}
/*Nome: inicioADC
...
void inicioADC()
{
 OpenADC(ADC_FOSC_32 & ADC_RIGHT_JUST & ADC_0_TAD, ADC_CH0 & ADC_INT_ON & ADC_REF_VDD_VSS, ADC_1ANA);//seleciona as portas 0 e 1 como analógicas
}
